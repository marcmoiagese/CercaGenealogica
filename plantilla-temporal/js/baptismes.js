        ...
        resultats.forEach(p => {
            ...
            opcio.innerHTML = `
                <div style="padding: 8px; cursor: pointer;">
                    <strong>${p.nom} ${p.cognoms}</strong><br>
                    <small>${p.aniversari} - ${p.poblacio}</small>
                </div>
            `;
            opcio.dataset.id = p.id;
            opcio.dataset.nom = p.nom;
            opcio.dataset.cognoms = p.cognoms;
            opcio.dataset.aniversari = p.aniversari;
            opcio.dataset.poblacio = p.poblacio;
